...
# Este código genera todas las combinaciones posibles de k números elegidos de 1 a n usando backtracking, explorando todas las posibilidades de manera recursiva y retrocediendo cuando es necesario.
