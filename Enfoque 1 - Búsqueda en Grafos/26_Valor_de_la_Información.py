...
# Este código calcula el valor de la información adicional, definido como la diferencia entre el valor esperado con la nueva información y el valor esperado previo a obtenerla.
