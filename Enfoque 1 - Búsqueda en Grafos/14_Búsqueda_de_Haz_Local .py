...
# Este código busca la mejor solución explorando varios estados simultáneamente, manteniendo un "haz" de los mejores estados y generando vecinos de todos ellos en cada iteración. Solo se conservan los mejores según la evaluación.
