...
# Este código resuelve un problema de satisfacción de restricciones (CSP) usando backtracking combinado con "cut conditioning", que reduce los dominios de variables no asignadas basándose en la asignación actual para evitar conflictos.
