...
# Farid Ariel Orozco Sanchez - 21310200
# 6 E2 2do Parcial

# Este programa implementa el algoritmo A*, un método de búsqueda informada que utiliza una función heurística para encontrar el camino más corto desde un nodo inicial hasta un nodo objetivo.
# A* combina:
...
# En este ejemplo, la heurística usada es la distancia absoluta entre el nodo actual y el objetivo: heuristic(a, b) = |a - b|.
