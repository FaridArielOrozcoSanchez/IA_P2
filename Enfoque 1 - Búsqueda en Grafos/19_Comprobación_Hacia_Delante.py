...
# Este código busca un camino desde un nodo inicial hasta un nodo objetivo en un grafo, usando backtracking con forward checking para evitar caminos que lleven a callejones sin salida.
