...
# Este código implementa el algoritmo de iteración de valores para un proceso de decisión de Markov (MDP), calculando la función de valor óptima para cada estado.
