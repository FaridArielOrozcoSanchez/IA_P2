...
# Este código implementa la búsqueda tabú para encontrar la mejor solución  a un problema. Evita ciclos manteniendo una lista de soluciones recientes  (tabú) y explora los vecinos de la solución actual buscando mejorarla.
