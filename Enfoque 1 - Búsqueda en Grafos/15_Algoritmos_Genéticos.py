...
# 6 E2 2do Parcial
# Este código implementa un algoritmo genético para encontrar la mejor solución explorando una población de individuos, aplicando selección, cruce y mutación a lo largo de varias generaciones.
