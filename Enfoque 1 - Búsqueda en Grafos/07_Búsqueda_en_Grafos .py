...
# 1. Búsqueda en Anchura (BFS): Recorre el grafo por niveles, es decir, primero visita los nodos más cercanos al inicio.

# 2. Búsqueda en Profundidad (DFS): Explora cada rama hasta el final antes de retroceder y continuar por otro camino.

# El usuario puede elegir la estrategia deseada pasando 'bfs' o 'dfs' como parámetro en la función graph_search().
