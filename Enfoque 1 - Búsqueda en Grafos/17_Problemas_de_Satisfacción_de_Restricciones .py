# Problemas de satisfraccion de restricciones
# Farid Ariel Orozco Sanchez - 21310200
# 6 E2 2do Parcial

# Este código implementa un CSP usando backtracking. Se busca asignar valores a las variables de manera que se cumplan todas las restricciones definidas.
