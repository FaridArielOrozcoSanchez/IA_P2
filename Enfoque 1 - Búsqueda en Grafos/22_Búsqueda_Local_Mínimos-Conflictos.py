...
# Este código resuelve un problema de satisfacción de restricciones (CSP) usando un enfoque de búsqueda local. Intenta minimizar el número de conflictos eligiendo variables conflictivas y asignándoles valores que reduzcan los conflictos.
