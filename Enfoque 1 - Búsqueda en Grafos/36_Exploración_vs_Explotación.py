...
# Se actualizan de manera incremental los valores promedio de cada brazo y se simula el proceso durante varias rondas, mostrando cómo se balancea la exploración con la explotación.
