...
# Este código implementa una búsqueda online, donde el agente toma decisiones secuenciales desde un estado inicial, sin conocimiento completo del entorno, hasta alcanzar un estado objetivo.
