...
# Este código busca una solución óptima explorando vecinos de la solución actual, aceptando soluciones peores con cierta probabilidad que disminuye con la temperatura, lo que permite escapar de óptimos locales.
