...
# Básicamente, hace varias búsquedas en profundidad pero aumentando el límite cada vez. Así, primero busca a nivel 0, luego a nivel 1, luego a nivel 2, etc., hasta que encuentra el objetivo.
